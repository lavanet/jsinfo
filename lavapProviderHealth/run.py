...
JSINFO_LAVAP_PROVIDER_HEALTH_COMMAND_TEMPLATE = "lavap test health healthAllProviders.yml --node {}"
...
JSINFO_LAVAP_PROVIDER_HEALTH_TIMEOUT = 2 * 60
...
# Check if JSINFO_LAVAP_PROVIDER_HEALTH_IS_PRODUCTION is set and true
JSINFO_LAVAP_PROVIDER_HEALTH_IS_PRODUCTION = os.getenv('JSINFO_LAVAP_PROVIDER_HEALTH_IS_PRODUCTION', 'false').lower() == 'true'

# Set INTERVAL based on JSINFO_LAVAP_PROVIDER_HEALTH_IS_PRODUCTION
JSINFO_LAVAP_PROVIDER_HEALTH_INTERVAL = 15 * 60 if JSINFO_LAVAP_PROVIDER_HEALTH_IS_PRODUCTION else 5 * 60
