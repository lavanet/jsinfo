...
while true; do
    ...
    echo "QueryProviderDualStackingDelegatorRewardsPod $(date) :: Starting 'env JSINFO_QUERY_LAVAP_DUAL_STACKING_DELEGATOR_REWARDS_ENDPOINT_ENABLED=true JSINFO_QUERY_PORT=$JSINFO_QUERY_PORT JSINFO_QUERY_IS_DEBUG_MODE=$DEBUG_MODE $CMD'... with ${BUN_TIMEOUT} minute timeout"
    env JSINFO_QUERY_LAVAP_DUAL_STACKING_DELEGATOR_REWARDS_ENDPOINT_ENABLED=true JSINFO_QUERY_PORT=$JSINFO_QUERY_PORT JSINFO_QUERY_IS_DEBUG_MODE=$DEBUG_MODE timeout ${BUN_TIMEOUT}m $CMD || true
    echo "QueryProviderDualStackingDelegatorRewardsPod $(date) :: 'env JSINFO_QUERY_LAVAP_DUAL_STACKING_DELEGATOR_REWARDS_ENDPOINT_ENABLED=true JSINFO_QUERY_PORT=$JSINFO_QUERY_PORT JSINFO_QUERY_IS_DEBUG_MODE=$DEBUG_MODE $CMD' stopped, restarting..."
    sleep 1
done &
