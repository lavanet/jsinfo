...
class ProviderStakesData extends RequestHandlerBase<JsinfoSchema.ProviderStake> {
    ...
    public GetInstance()(addr: string): ProviderStakesData {
        return ProviderStakesData.GetInstance()(addr);
    }
    ...
    protected async fetchAllDataFromDb(): Promise < JsinfoSchema.ProviderStake[] > {
...
return stakesRes;
    ...
    public async fetchDataWithPaginationFromDb(pagination: Pagination): Promise < JsinfoSchema.ProviderStake[] | null > {
