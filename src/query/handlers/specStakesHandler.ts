...
class SpecStakesData extends RequestHandlerBase<SpecSpecsResponse> {
    private spec: string;
    ...
    public GetInstance()(spec: string): SpecStakesData {
        return SpecStakesData.GetInstance()(spec);
    }
    ...
    protected async fetchAllDataFromDb(): Promise < SpecSpecsResponse[] > {
    ...
    public async fetchDataWithPaginationFromDb(pagination: Pagination): Promise < SpecSpecsResponse[] | null > {
